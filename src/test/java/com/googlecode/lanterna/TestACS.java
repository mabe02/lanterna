...
public class TestACS
{
    ...
    {        
        ...
        System.out.println();
        System.out.println("SINGLE_LINE_TOP_LEFT_CORNER = " + ACS.SINGLE_LINE_TOP_LEFT_CORNER);
        System.out.println("DOUBLE_LINE_TOP_LEFT_CORNER = " + ACS.DOUBLE_LINE_TOP_LEFT_CORNER);
        System.out.println("SINGLE_LINE_TOP_RIGHT_CORNER = " + ACS.SINGLE_LINE_TOP_RIGHT_CORNER);
        System.out.println("DOUBLE_LINE_TOP_RIGHT_CORNER = " + ACS.DOUBLE_LINE_TOP_RIGHT_CORNER);
        System.out.println();
        System.out.println("SINGLE_LINE_BOTTOM_LEFT_CORNER = " + ACS.SINGLE_LINE_BOTTOM_LEFT_CORNER);
        System.out.println("DOUBLE_LINE_BOTTOM_LEFT_CORNER = " + ACS.DOUBLE_LINE_BOTTOM_LEFT_CORNER);
        System.out.println("SINGLE_LINE_BOTTOM_RIGHT_CORNER = " + ACS.SINGLE_LINE_BOTTOM_RIGHT_CORNER);
        System.out.println("DOUBLE_LINE_BOTTOM_RIGHT_CORNER = " + ACS.DOUBLE_LINE_BOTTOM_RIGHT_CORNER);
        System.out.println();

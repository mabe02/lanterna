...
public class TestTerminalPosition {
    ...
    public void testObjectChurnReduced_of() {
        ...
        assertSameSystemIdentityHashCode(tp(0, 0), tp(0, 0));
        assertSameSystemIdentityHashCode(tp(0, 1), tp(0, 1));
        assertSameSystemIdentityHashCode(tp(1, 0), tp(1, 0));
        assertSameSystemIdentityHashCode(tp(1, 1), tp(1, 1));
    }
    @Test
    ...
    public void test_withX() {
        ...
        assertTrue(a.x() == 35);
        assertTrue(a.withX(20).equals(20, 40));
    }
    @Test
    public void test_withY() {
        TerminalPosition a = tp(35, 40);
        assertTrue(a.y() == 40);
        assertTrue(a.withY(15).equals(35, 15));
    }
    @Test
    ...
    public void test_divide() {
        assertTrue(tp(11, 22).divide(2).equals(5, 11));
        assertTrue(tp(11, 22).divide(5).equals(2, 4));
        assertTrue(tp(20, 22).divide(1).equals(20, 22));
        assertTrue(tp(20, 30).divide(4).equals(5, 7));
        ...
        assertTrue(tp(11, 22).divide(tp(1, 2)).equals(11, 11));
        assertTrue(tp(11, 22).divide(tp(1, 5)).equals(11, 4));
        assertTrue(tp(20, 22).divide(tp(4, 1)).equals(5, 22));
        assertTrue(tp(20, 30).divide(tp(1, 4)).equals(20, 7));
    }
    @Test
    ...
    public void test_max() {
        assertTrue(tp(5, 8).max(tp(9, 7)).equals(9, 8));
        assertTrue(tp(5, 8).max(tp(4, 9)).equals(5, 9));
        assertTrue(tp(0, 0).max(tp(4, 9)).equals(4, 9));
    }
    @Test

...
public class TestTerminalSize {
    ...
    public void testSystemIdentityHashCodeSame() {
        TerminalSize a = TerminalSize.of(1, 1);
        TerminalSize b = TerminalSize.of(1, 1);
        assertSameSystemIdentityHashCode(a, b);
    }
    @Test
    ...
    public void testObjectChurnReduced_of() {
        ...
        assertSameSystemIdentityHashCode(ts(0, 0), ts(0, 0));
        assertSameSystemIdentityHashCode(ts(0, 1), ts(0, 1));
        assertSameSystemIdentityHashCode(ts(1, 0), ts(1, 0));
        assertSameSystemIdentityHashCode(ts(1, 1), ts(1, 1));
    }
    @Test
    public void testObjectChurnReduced_as() {
        TerminalSize size = ts(35, 40);
        assertSameSystemIdentityHashCode(size, size.as(35, 40));
        assertSameSystemIdentityHashCode(size, size.as(ts(35, 40)));
    }
    @Test
    public void testObjectChurnReduced_plus() {
        ...
        TerminalSize size = ts(35, 40);
        assertSameSystemIdentityHashCode(size, size.plus(0, 0));
    }
    @Test
    public void testObjectChurnReduced_minus() {
        ...
        TerminalSize size = ts(35, 40);
        assertSameSystemIdentityHashCode(size, size.minus(0, 0));
    }
    @Test
    public void testObjectChurnReduced_divide() {
        TerminalSize size = ts(35, 40);
        assertSameSystemIdentityHashCode(size, size.divide(1, 1));
    }
    @Test
    public void testObjectChurnReduced_multiply() {
        TerminalSize size = ts(35, 40);
        assertSameSystemIdentityHashCode(size, size.multiply(1, 1));
    }
    // ------------------------------------------------------
    ...
    public void test_withWidth() {
        ...
        assertTrue(a.withWidth(20).equals(20, 40));
    }
    @Test
    public void test_withHeight() {
        TerminalSize a = ts(35, 40);
        assertTrue(a.height() == 40);
        assertTrue(a.withHeight(15).equals(35, 15));
    }
    @Test
    public void test_withColumns() {
        TerminalSize a = ts(35, 40);
        assertTrue(a.getColumns() == 35);
        assertTrue(a.withColumns(20).equals(20, 40));
    }
    @Test
    public void test_withRows() {
        TerminalSize a = ts(35, 40);
    ...
    public void testObjectChurnReduced_with() {
        TerminalSize size = ts(35, 40);
        assertSameSystemIdentityHashCode(size, size.with(size));
    }
    ...
    public void test_divide() {
        assertTrue(ts(11, 22).divide(2).equals(5, 11));
        assertTrue(ts(11, 22).divide(5).equals(2, 4));
        assertTrue(ts(20, 22).divide(1).equals(20, 22));
        assertTrue(ts(20, 30).divide(4).equals(5, 7));
        ...
        assertTrue(ts(11, 22).divide(ts(1, 2)).equals(11, 11));
        assertTrue(ts(11, 22).divide(ts(1, 5)).equals(11, 4));
        assertTrue(ts(20, 22).divide(ts(4, 1)).equals(5, 22));
        assertTrue(ts(20, 30).divide(ts(1, 4)).equals(20, 7));
    }
    @Test
    ...
    public void test_max() {
        assertTrue(ts(5, 8).max(ts(9, 7)).equals(9, 8));
        assertTrue(ts(5, 8).max(ts(4, 9)).equals(5, 9));
        assertTrue(ts(0, 0).max(ts(4, 9)).equals(4, 9));
    }
    @Test

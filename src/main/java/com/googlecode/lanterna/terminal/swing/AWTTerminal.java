...
public class AWTTerminal extends Component implements IOSafeTerminal {
    ...
    public AWTTerminal(
        ...
        this.enquiryString = "AwtTerminal";
        //this.blinkTimer = new Timer(deviceConfiguration.getBlinkLengthInMilliSeconds(), new BlinkTimerCallback());
        this.blinkTimer = new Timer(true);  // isDeamon true: let VM finish as it pleases
        ...
        //Awt double-buffering is handled in main Window or Canvas
        ...
        addHierarchyListener(new HierarchyListener() {
            private BlinkTimerCallback blinkTimerCallback = null;
    ...
    ///////////
    private class BlinkTimerCallback extends TimerTask { //implements ActionListener {
        @Override

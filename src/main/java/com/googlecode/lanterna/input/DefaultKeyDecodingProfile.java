    ...
    private static final List<CharacterPattern> COMMON_PATTERNS
            = new ArrayList<CharacterPattern>(Arrays.asList(
                            new CharacterPattern[]{
                                ...
                                new BasicCharacterPattern(new KeyStroke(KeyType.ArrowUp, true, false), ESC_CODE, '[', '1', ';', '5', 'B'),
                                ...
                                new BasicCharacterPattern(new KeyStroke(KeyType.ArrowUp, true, false), ESC_CODE, '[', '1', ';', '5', 'C'),
                                ...
                                new BasicCharacterPattern(new KeyStroke(KeyType.ArrowUp, true, false), ESC_CODE, '[', '1', ';', '5', 'D'),

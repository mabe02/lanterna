...
public class TerminalSize implements Comparable<TerminalSize> {
    ...
    private static final TerminalSize OF_0x0 = new TerminalSize(0, 0);
    private static final TerminalSize OF_0x1 = new TerminalSize(0, 1);
    private static final TerminalSize OF_1x0 = new TerminalSize(1, 0);
    private static final TerminalSize OF_1x1 = new TerminalSize(1, 1);
    
    @Deprecated
    public static final TerminalSize ZERO = TerminalSize.of(0, 0);
    @Deprecated
    public static final TerminalSize ONE = TerminalSize.of(1, 1);
    ...
    public static final TerminalSize of(int columns, int rows) {
        if (columns == 0 && rows == 0) { return OF_0x0; }
        if (columns == 0 && rows == 1) { return OF_0x1; }
        if (columns == 1 && rows == 0) { return OF_1x0; }
        if (columns == 1 && rows == 1) { return OF_1x1; }
     ...
     */
    public TerminalSize withWidth(int columns) {
     ...
     */
    public TerminalSize withHeight(int rows) {
        return as(columns, rows);
    }
    /**
     * Obtain a TerminalSize with this instance's number of columns and the supplied number of rows

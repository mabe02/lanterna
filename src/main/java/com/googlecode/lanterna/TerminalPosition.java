...
public class TerminalPosition implements Comparable<TerminalPosition> {
     ...
     */
    private static final TerminalPosition OF_0x0 = new TerminalPosition(0, 0);
    private static final TerminalPosition OF_0x1 = new TerminalPosition(0, 1);
    private static final TerminalPosition OF_1x0 = new TerminalPosition(1, 0);
    private static final TerminalPosition OF_1x1 = new TerminalPosition(1, 1);
    
    @Deprecated
    public static final TerminalPosition TOP_LEFT_CORNER = TerminalPosition.of(0, 0);
    @Deprecated
    public static final TerminalPosition OFFSET_1x1 = TerminalPosition.of(1, 1);
    ...
    public static final TerminalPosition of(int column, int row) {
        if (column == 0 && row == 0) { return OF_0x0; }
        if (column == 0 && row == 1) { return OF_0x1; }
        if (column == 1 && row == 0) { return OF_1x0; }
        if (column == 1 && row == 1) { return OF_1x1; }
     ...
     */
    public TerminalPosition withX(int column) {
        return as(column, row);
    }
    /**
     * synonymous for withX(int column)
     */
     ...
     */
    public TerminalPosition withY(int row) {
        return as(column, row);
    }
    /**
     * synonymous for withY(int row)
     */
